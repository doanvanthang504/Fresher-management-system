...
namespace Infrastructures.Tests.Repositories
{
    public class GenericRepositoryTests : SetupTest
    {
        ...
        {
            var mockData = _fixture.Build<Chemical>().With(e => e.IsDeleted, false).Create();
            await _dbContext.Chemicals.AddRangeAsync(mockData);
        ...
        {
            var mockData = _fixture.Build<Chemical>().With(e => e.IsDeleted, false).CreateMany(45).ToList();
            await _dbContext.Chemicals.AddRangeAsync(mockData);
            await _dbContext.SaveChangesAsync();
